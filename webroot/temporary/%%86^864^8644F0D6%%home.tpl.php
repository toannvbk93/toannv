<?php /* Smarty version 2.6.6, created on 2017-05-14 10:02:41
            ...
            <?php echo '
                ...
                $(document).ready(function(){
                    ...
                    function lastAddedLiveFunc()
                    {
                        ...
                        $.get("';  echo $this->_tpl_vars['baseurl'];  echo '/homejson.php?page="+tpage, function(data){
                            if (data != "") {
                                $(".col-1").append(data);
                    ...
                    $(window).scroll(function(){
                        ...
                        if  ((curloc+document.documentElement.clientHeight+1)>=($(document).height()-400) && ajaxstart==1 ) {
                            if (tpage <= totPageLoad) {
                                ...
                                $(\'#next_page\').attr(\'href\', "';  echo $this->_tpl_vars['baseurl'];  echo '?page="+tpage);
                                $(\'#view_more_div\').show();
                            }
                        };
