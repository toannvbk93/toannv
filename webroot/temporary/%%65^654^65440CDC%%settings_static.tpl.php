<?php /* Smarty version 2.6.6, created on 2017-05-15 15:40:39
...
" class=" required-entry required-entry input-text" type="text"  style="width:700px"/>
                                                ...
                                                <tbody>
                                                    <tr class="hidden">
                                                        <td class="label"><label for="status">Tiêu Đề Event</label></td>
                                                        <td class="value">
                                                            <input id="title" name="title" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['static6']['title'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)))) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
" class=" required-entry required-entry input-text" type="text"  style="width:700px"/>
                                                        </td>
                                                    </tr>   
                                                    <tr class="hidden">
                                                        <td class="label"><label for="status">Nội Dung </label></td>
                                                        <td class="value">
                                                            <textarea id="value" name="value" class=" textarea" type="textarea" style="width:700px; height:400px;" ><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['static6']['value'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)))) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
</textarea>
                                                        </td>
                                                    </tr>  
                                                    <tr class="hidden">
                                                ...
                                                <input type="hidden" id="submitform5" name="submitform6" value="1" >
                                                </form>
                                            </div>
                                        </fieldset>
									</div>
