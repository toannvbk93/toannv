...
/thumbs/<?php if ($this->_tpl_vars['users'][$this->_sections['i']['index']]['profilepicture'] == ""): ?>noprofilepicture.jpg<?php else:  echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['profilepicture'];  endif; ?>?<?php echo time(); ?>
" style="border: 2px solid rgb(187, 187, 187); float: left; margin-right: 10px;width:80px;height:80px;">
...
" style="font-size: 16px; font-weight: bold; padding-bottom: 5px; margin-bottom: 6px; border-bottom: 1px solid rgb(242, 242, 242); display: block;"><?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['username']; ?>
					...
					<a href="<?php echo $this->_tpl_vars['baseurl']; ?>
/user/<?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['USERID']; ?>
" style="font-size: 12px; color: rgb(68, 68, 68);">Hạng: <?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['rank']; ?>
&nbsp;&nbsp;<span style="color: rgb(238, 238, 238);">|</span>&nbsp;&nbsp;Bài gửi: <?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['posts']; ?>
&nbsp;&nbsp;<span style="color: rgb(238, 238, 238);">|</span>&nbsp;&nbsp;Lượt xem: <?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['yourviewed']; ?>
&nbsp;&nbsp;<span style="color: rgb(238, 238, 238);">|</span>&nbsp;&nbsp;Điểm: <?php echo $this->_tpl_vars['users'][$this->_sections['i']['index']]['points']; ?>
</a>
					</div>
					<div class="clear"></div>
