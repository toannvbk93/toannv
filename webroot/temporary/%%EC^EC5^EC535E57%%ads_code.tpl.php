                                ...
                                <div id="isoft_group_1_content" style="display:none;">
                                	<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">Mã Quảng Cáo #<?php echo $_REQUEST['AID']; ?>
</h4>
										...
										<fieldset id="group_fields4">
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                	<tr class="hidden">
                                                        <td class="label"><label for="name">Mã chèn </label></td>
                                                        <td class="value">
                                                        	<textarea id="acode" name="acode" class=" textarea" type="textarea" ><?php echo '{insert name=get_advertisement value=var AID="';  echo $_REQUEST['AID'];  echo '"}'; ?>
</textarea>
                                                        </td>
                                                        <td class="scope-label">[CHÈN VÀO TỆP TIN GIAO DIỆN NƠI BẠN MUỐN HIỆN QUẢNG CÁO]</td>
                                                            <td><small></small></td>
                                                    </tr>
                                                </tbody>
                                                </table>
...
unset($_smarty_tpl_vars);
 ?>
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Quảng Cáo - Mã Quảng Cáo</h3>
