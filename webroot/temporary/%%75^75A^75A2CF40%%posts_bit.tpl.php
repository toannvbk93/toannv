...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'posts_bit.tpl', 1, false),array('modifier', 'truncate', 'posts_bit.tpl', 1, false),array('insert', 'return_youtube2', 'posts_bit.tpl', 21, false),array('insert', 'return_fod2', 'posts_bit.tpl', 26, false),array('insert', 'return_vfy2', 'posts_bit.tpl', 29, false),array('insert', 'return_vmo2', 'posts_bit.tpl', 31, false),array('insert', 'get_time_to_days_ago', 'posts_bit.tpl', 50, false),array('insert', 'get_advertisement', 'posts_bit.tpl', 106, false),)), $this); ?>
...
" data-text="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['posts'][$this->_sections['i']['index']]['story'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 20, "...", true) : smarty_modifier_truncate($_tmp, 20, "...", true)); ?>
