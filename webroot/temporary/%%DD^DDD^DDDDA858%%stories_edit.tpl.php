...
" <?php if ($this->_tpl_vars['c'][$this->_sections['i']['index']]['CID'] == $this->_tpl_vars['story']['CID']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['c'][$this->_sections['i']['index']]['cname']; ?>
                                                    ...
                                                    <tr class="hidden">
                                                        <td class="label"><label for="view">Lượt Xem </label></td>
                                                        <td class="value">
                                                            <input id="postviewed" name="view" value="<?php echo $this->_tpl_vars['story']['view']; ?>
" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
...
" class=" required-entry required-entry input-text" type="text"/>
                                                    ...
                                                    <tr class="hidden">
                                                        <td class="label"><label for="marknew">Hiển thị mới nhất</label></td>
                                                        <td class="value">
                                                        ...
                                                        <td class="scope-label">[HIỂN THỊ BÀI ĐĂNG TRÊN CÙNG CỦA TRANG MỚI HOẶC TRANG HOT]</td>
                                                        <td><small></small></td>
                                                    </tr>
                                                    <tr class="hidden">
...
" target="_blank"><?php echo $this->_tpl_vars['story']['pip']; ?>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td width="700" height="350">
                                                         <textarea class="ckeditor" name="blog"><?php echo ((is_array($_tmp=$this->_tpl_vars['story']['blog'])) ? $this->_run_mod_handler('strip_mq_gpc', true, $_tmp) : strip_mq_gpc($_tmp)); ?>
</textarea>
