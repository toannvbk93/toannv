...
" class=" required-entry required-entry input-text" type="text"/>
                                                        ...
                                                        <td class="scope-label">[SỐ LƯỢT VIEW CẦN ĐẠT ĐƯỢC TRƯỚC KHI BÀI ĐĂNG ĐƯỢC CHUYỂN TỪ TRANG BÀI MỚI SANG TRANG ĐANG HOT]</td>
                                                        <td><small></small></td>
                                                    </tr>
...
" class=" required-entry required-entry input-text" type="text"/>
                                                    ...
                                                    <tr class="hidden">
                                                        <td class="label"><label for="status">Website name </label></td>
                                                        <td class="value">
                                                            <input id="website_name" name="website_name" value="<?php echo $this->_tpl_vars['website_name']; ?>
" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                        <td class="scope-label">[Website name]</td>
                                                        <td><small></small></td>
                                                    </tr>
