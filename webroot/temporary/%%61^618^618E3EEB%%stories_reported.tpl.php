<?php /* Smarty version 2.6.6, created on 2017-05-13 15:59:07
         compiled from administrator/stories_reported.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'administrator/stories_reported.tpl', 111, false),array('modifier', 'truncate', 'administrator/stories_reported.tpl', 139, false),array('modifier', 'date_format', 'administrator/stories_reported.tpl', 141, false),)), $this); ?>
...
&toid=<?php echo $this->_tpl_vars['toid']; ?>
&story=<?php echo $this->_tpl_vars['story']; ?>
&active=<?php echo $this->_tpl_vars['active'];  endif; ?>" name="story" class="<?php if ($this->_tpl_vars['sortby'] == 'story'): ?>sort-arrow-<?php if ($this->_tpl_vars['sorthow'] == 'desc'): ?>desc<?php else: ?>asc<?php endif;  else: ?>not-sort<?php endif; ?>"><span class="sort-title">Tiêu Đề</span></a></span></th>
                                        <th ><span class="nobr"><a href="stories_reported.php?page=<?php echo $this->_tpl_vars['currentpage']; ?>
...
&toid=<?php echo $this->_tpl_vars['toid']; ?>
&story=<?php echo $this->_tpl_vars['story']; ?>
&active=<?php echo $this->_tpl_vars['active'];  endif; ?>" name="time" class="<?php if ($this->_tpl_vars['sortby'] == 'time'): ?>sort-arrow-<?php if ($this->_tpl_vars['sorthow'] == 'desc'): ?>desc<?php else: ?>asc<?php endif;  else: ?>not-sort<?php endif; ?>"><span class="sort-title">Ngày Báo Lỗi</span></a></span></th>
                                        <th ><span class="nobr"><a href="stories_reported.php?page=<?php echo $this->_tpl_vars['currentpage']; ?>
...
/<?php echo $this->_tpl_vars['results'][$this->_sections['i']['index']]['path']; ?>
