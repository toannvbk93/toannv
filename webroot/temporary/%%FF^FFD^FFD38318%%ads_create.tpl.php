<?php /* Smarty version 2.6.6, created on 2017-05-14 17:41:27
...
" class=" required-entry required-entry input-text" type="text"/>
                                                	...
                                                	<tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                        	<textarea id="code" name="maqc" class=" textarea" type="textarea" ><?php echo ((is_array($_tmp=$_REQUEST['code'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</textarea>
                                                        </td>
