<?php /* Smarty version 2.6.6, created on 2017-05-15 16:01:27
         compiled from administrator/stories_manage.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'administrator/stories_manage.tpl', 89, false),array('modifier', 'truncate', 'administrator/stories_manage.tpl', 121, false),array('modifier', 'date_format', 'administrator/stories_manage.tpl', 123, false),)), $this); ?>
...
?>
                                    <tr id="" >
                                        <td class=" a-right ">
                                        <center>
                                        <?php echo $this->_tpl_vars['results'][$this->_sections['i']['index']]['PID'];  if ($this->_tpl_vars['results'][$this->_sections['i']['index']]['pic'] != ""): ?>
                                        <?php if ($this->_tpl_vars['results'][$this->_sections['i']['index']]['isgif'] == '1'): ?>
                                        <br /><img width="215px" src="<?php echo $this->_tpl_vars['purl']; ?>
/<?php echo $this->_tpl_vars['results'][$this->_sections['i']['index']]['path']; ?>
/t/static-<?php echo $this->_tpl_vars['results'][$this->_sections['i']['index']]['pic']; ?>
" />
                                        <?php else: ?>
                                        <br /><img src="<?php echo $this->_tpl_vars['purl']; ?>
/<?php echo $this->_tpl_vars['results'][$this->_sections['i']['index']]['path']; ?>
