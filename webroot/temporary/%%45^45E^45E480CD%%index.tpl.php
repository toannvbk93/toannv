<?php /* Smarty version 2.6.6, created on 2017-03-23 17:25:17
         compiled from index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'makeseo', 'index.tpl', 5, false),array('modifier', 'stripslashes', 'index.tpl', 6, false),array('insert', 'get_advertisement', 'index.tpl', 15, false),)), $this); ?>
...
/hot?view=thumbs" title="Toggle Views"><?php echo $this->_tpl_vars['lang258']; ?>
</a>
			<?php endif; ?>
					...
					$(window).scroll(function(){
						...
						if  ((curloc+document.documentElement.clientHeight+1)>=($(document).height()-400) && ajaxstart==1 ) {
							if (tpage <= totPageLoad) {
								...
								$(\'#next_page\').attr(\'href\', "';  echo $this->_tpl_vars['baseurl'];  echo '/hot?page="+tpage);
								$(\'#view_more_div\').show();
							}
						};
