<?php /* Smarty version 2.6.6, created on 2017-05-14 18:00:33
...
" target="_blank">Xem Trang</a><span class="separator">|</span><a href="logout.php" class="link-logout">Đăng Xuất</a>
            ...
            <div class="nav-bar">
            	<ul id="nav">
                    ...
                    <li onmouseover="Element.addClassName(this,'over')" onmouseout="Element.removeClassName(this,'over')" class="<?php if ($this->_tpl_vars['mainmenu'] == '14'): ?>active<?php endif; ?>   parent level0"> <a href="#"  onclick="return false" class=""><span>Lấy bài</span></a>
                    	<ul >
                            <li  class="   level1"> <a href="page.php"   class=""><span>Lấy bài page hài</span></a></li>
                              <li  class="   level1"> <a href="gai.php"   class=""><span>Lấy bài gái xinh</span></a></li>
                        </ul>
                    </li>
                </ul>
			</div>
