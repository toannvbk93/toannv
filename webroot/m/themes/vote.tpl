		...
		<div id="sidemenu">
			...
			<nav id="nav-container">
				<ul class="nav">
					...
					<li>
						<a href="{$mobileurl}/vote" class="current nav-with-ul">Bình chọn</a>
			...
			<div class="text-center" style="margin-bottom: 40px;">
				{if $tpp ne ""}
				<a href="{$mobileurl}/vote?page={$tpp}" class="button radius">Trang trước</a>
				{else}
				<a href="#" class="button secondary radius">Trang trước</a>
				{/if}
				{if $tnp ne ""}
				<a href="{$mobileurl}/vote?page={$tnp}" class="button radius">Trang sau</a>
				{else}
