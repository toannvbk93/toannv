	        	...
	        	<div id="sidemenu">
		        	...
		        	<nav id="nav-container">
		        		...
		        		<ul class="nav">
		        			...
		        			<li><a href="{$mobileurl}">Trang chủ</a></li>
							<li>
		        			...
		        			<li>
		        				<a href="{$mobileurl}/trending" class="current nav-with-ul">Cũ mà hay</a>
		        				<!--<span class="nav-child-container"><span class="nav-child-trigger">+</span></span>
		        				<ul style="height: 0;">
		        			...
		        			<li><a href="{$mobileurl}/vote" class="nav-with-ul">Mới đăng</a>
		        				<!--<span class="nav-child-container"><span class="nav-child-trigger">+</span></span>
		        				<ul style="height: 0;">
		...
		<!-- =Sidebar -->
	        ...
	        <!-- =Header -->
				...
				{/section}
					...
					{if $tpp ne ""}
						<a href="{$mobileurl}/trending?page={$tpp}" class="button radius">Trang trước</a>
						{else}
						<a href="#" class="button secondary radius">Trang trước</a>
						 {/if}
						{if $tnp ne ""}
						<a href="{$mobileurl}/trending?page={$tnp}" class="button radius">Trang sau</a>
						  {else}
