	...
	<section id="content-container" class="dark">
		...
		<div id="content" class="blog">
			...
			<article class="format-standard">
				...
				<div class="wrapped-content">
					<p class="title">
						<span class="icon-eye-1"></span>{$posts[i].view}
			...
			<div class="text-center" style="margin-bottom: 40px;">
				{if $tpp ne ""}
				<a href="{$mobileurl}/search?page={$tpp}" class="button radius">Trang trước</a>
				{else}
				<a href="#" class="button secondary radius">Trang trước</a>
				{/if}
				{if $tnp ne ""}
				<a href="{$mobileurl}/search?page={$tnp}" class="button radius">Trang sau</a>
				{else}
