...
$query2 = "SELECT A.*, B.username from posts A, members B where A.active='1' AND A.USERID=B.USERID AND A.view>= '500' order by A.time_added desc limit $pagingstart, $config[mobile_per_page]";
