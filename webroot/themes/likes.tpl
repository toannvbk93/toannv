    ...
    <div id="content-holder">       
        ...
        <div class="main-filter with-topping">
            <ul class="content-type">            
                ...
                <li><a class="current"  href="{$baseurl}/user/{$p.USERID|stripslashes}/likes"><strong>{$lang193}</strong> ({$totallikes})</a></li>            
        ...
        <div id="content" listPage="">
            ...
            <div id="paging-buttons" class="paging-buttons">
                {if $tpp ne ""}
                <a href="{$baseurl}/user/{$p.USERID|stripslashes}/likes?page={$tpp}" class="previous">&laquo; {$lang166}</a>
                {else}
                <a href="#" onclick="return false;" class="previous disabled">&laquo; {$lang166}</a>
                {/if}
                {if $tnp ne ""}
                <a href="{$baseurl}/user/{$p.USERID|stripslashes}/likes?page={$tnp}" class="older">{$lang167} &raquo;</a>
                {else}
