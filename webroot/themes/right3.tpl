	<div class="side-bar">
     ...
     <div class="s-300" id="top-s300">
		...
		<div>
	<div class="fb-like-box" data-href="https://www.facebook.com/cgcn" data-width="300" data-height="400" data-colorscheme="light" data-show-faces="true" data-header="false" data-stream="false" data-show-border="false"></div>
...
{/if}
			...
			<div class="section-2" style="display:none;">
				...
				<ul class="sideinfo side-items-left" style="font-weight: bold; font-size: 11px; margin-bottom: 10px; padding-left: 0px;">
					<li><a href="#" target="_blank"><b>Powered by cgcn</b></a>. {$site_name|stripslashes} &copy; 2014</li>
