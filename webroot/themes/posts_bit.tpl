                    <li class=" gag-link" data-url="{$baseurl}{$postfolder}{$posts[i].PID}" data-text="{$posts[i].story|stripslashes|truncate:20:"...":true}" gagId="{$posts[i].PID}" itemType="list" id="entry-{$posts[i].PID}">
                        <div class="content">
                            <div class="img-wrap">
