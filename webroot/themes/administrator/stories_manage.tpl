                            ...
                            <div class="hor-scroll">
                                ...
                                <tbody>
                                    ...
                                    <tr id="" >
                                        <td class=" a-right ">
                                        <center>
                                        {$results[i].PID}{if $results[i].pic ne ""}
                                        {if $results[i].isgif eq "1"}
                                        <br /><img width="215px" src="{$purl}/{$results[i].path}/t/static-{$results[i].pic}" />
                                        {else}
                                        <br /><img src="{$purl}/{$results[i].path}/t/s-{$results[i].pic}" />
                                        {/if}
                                        ...
                                        <td class=" ">
                                            ...
                                            <a href="javascript: document.a{$results[i].PID}.submit();">{if $results[i].active eq "1"}Có{else}Không{/if}</a>
                                        </td>
                                        <td class=" last"><a href="stories_edit.php?PID={$results[i].PID}">Sửa</a>&nbsp;|&nbsp;<a href="stories_manage.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&title={$title}&details={$details}&username={$username}&active={$active}{/if}&delete=1&PID={$results[i].PID}">Xóa</a></td>
                                    </tr>
                                    {/section}
                                    <tr>
                                        <td colspan="6">
