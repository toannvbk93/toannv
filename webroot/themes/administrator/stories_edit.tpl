                                            ...
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                            <input id="postviewed" name="view" value="{$story.view}" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td width="700" height="350">
                                                         <textarea class="ckeditor" name="blog">{$story.blog|strip_mq_gpc}</textarea>
