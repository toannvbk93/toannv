            ...
            <div id="page:main-container">
				<div class="columns ">
        			...
        			<div id="customerGrid">
        				...
        				<tr>
                    		<td class="pager">
                            	Hiển thị {if $total gt 0}{$beginning} - {$ending} trên tổng số {/if}{$total} Quản Trị Viên
                    		</td>
							...
							<div class="hor-scroll">
	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" last">
                                        	<a href="admins_edit.php?ADMINID={$results[i].ADMINID}">Sửa</a>&nbsp;|&nbsp;
                                            <a href="admins_manage.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&email={$email}&username={$username}{/if}&delete=1&ADMINID={$results[i].ADMINID}">Xóa</a>
                                        </td>
                                	</tr>
                                    {/section}
                                    <tr>
