        ...
        <div class="header">
            ...
            <div class="nav-bar">
            	<ul id="nav">
                    ...
                    <li onmouseover="Element.addClassName(this,'over')" onmouseout="Element.removeClassName(this,'over')" class="{if $mainmenu eq "14"}active{/if}   parent level0"> <a href="#"  onclick="return false" class=""><span>Lấy bài</span></a>
                    	<ul >
