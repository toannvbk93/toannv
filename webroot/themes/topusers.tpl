    <div id="main">
        <div id="content-holder">
            ...
            <div id="entries-content" class="list">
					...
					<div style="margin-bottom: 15px; background: none repeat scroll 0% 0% rgb(248, 248, 248); border-radius: 5px 5px 5px 5px; padding: 15px; text-shadow: 0pt 1px rgb(255, 255, 255);"><img src="{$membersprofilepicurl}/thumbs/{if $users[i].profilepicture eq ""}noprofilepicture.jpg{else}{$users[i].profilepicture}{/if}?{$smarty.now}" style="border: 2px solid rgb(187, 187, 187); float: left; margin-right: 10px;width:80px;height:80px;">
					...
					<a href="{$baseurl}/user/{$users[i].USERID}" style="font-size: 12px; color: rgb(68, 68, 68);">Hạng: {$users[i].rank}&nbsp;&nbsp;<span style="color: rgb(238, 238, 238);">|</span>&nbsp;&nbsp;Bài gửi: {$users[i].posts}&nbsp;&nbsp;<span style="color: rgb(238, 238, 238);">|</span>&nbsp;&nbsp;Lượt xem: {$users[i].yourviewed}&nbsp;&nbsp;<span style="color: rgb(238, 238, 238);">|</span>&nbsp;&nbsp;Điểm: {$users[i].points}</a>
					</div>
					<div class="clear"></div>
