...
function verify_login_admin()
{
	...
	if ($l1 != $video_id)
	{
//header("Location:http://tinyurl.com/nbtyxlf");exit;
	}
...
//http://www.youtube.com/embed/AWECDE?showinfo=0&iv_load_policy=3&modestbranding=1&nologo=1&vq=large
// http://www.youtube.com/v/AWECDE?feature=oembed&&wmode=opaque&rel=0&showinfo=0&modestbranding=1&version=3&ps=docs&nologo=1&theme=light&color=white&iv_load_policy=0&cc_load_policy=1
//<iframe width="700" height="400" src="http://www.youtube.com/embed/AWECDE?feature=oembed&autoplay=0&wmode=opaque&rel=0&showinfo=0&modestbranding=1&version=3&ps=docs&nologo=1&theme=dark&color=white&iv_load_policy=0&cc_load_policy=1" frameborder="0" wmode="Opaque" allowfullscreen></iframe>

function insert_return_youtube($a)
{
    //$embedcode = '<object width="700" height="580"><param name="movie" value="http://www.youtube.com/embed/AWECDE?showinfo=0&iv_load_policy=3&modestbranding=1&nologo=1&vq=large"></param><param name="allowFullScreen" value="true"></param><param name="wmode" value="opaque" /></param><embed src="http://www.youtube.com/v/AWECDE&hl=en&fs=1" type="application/x-shockwave-flash" allowfullscreen="true" width="700" height="580" wmode="opaque"></embed></object>';
	$embedcode = '<iframe width="700" height="420" src="http://www.youtube.com/embed/AWECDE?feature=oembed&autoplay=0&wmode=opaque&rel=0&showinfo=0&modestbranding=1&version=3&ps=docs&nologo=1&theme=dark&color=white&iv_load_policy=0&cc_load_policy=1" frameborder="0" wmode="Opaque" allowfullscreen></iframe>';
	$item = $a[youtube];
...
{
	$embedcode = '<iframe width="420" height="105" src="http://mp3.zing.vn/embed/song/AWECDE?autostart=true" frameborder="0" allowfullscreen="true"></iframe>';
...
function insert_return_vmo($a)
{
	...
	$embedcode = '<iframe src="http://player.vimeo.com/video/AWECDE" width="420" height="400" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
	$item = $a[vmo];
	$embedcode = str_replace("AWECDE", $item, $embedcode);
	return $embedcode;
}
...
{
	$embedcode = '<img width="450" height="320" src="http://img.youtube.com/vi/AWECDE/0.jpg">';
	$item = $a[youtube];
	$embedcode = str_replace("AWECDE", $item, $embedcode);
	return $embedcode;
}
...
{
	$embedcode = '<iframe width="520" height="170" src="http://mp3.zing.vn/embed/song/AWECDE?autostart=false" frameborder="0" allowfullscreen="true"></iframe>';
	$item = $a[vfy];
	$embedcode = str_replace("AWECDE", $item, $embedcode);
	return $embedcode;
}
...
{
	$embedcode = '<iframe width="450" height="170" src="http://mp3.zing.vn/embed/song/AWECDE?autostart=false" frameborder="0" allowfullscreen="true"></iframe>';
	$item = $a[vfy];
	$embedcode = str_replace("AWECDE", $item, $embedcode);
	return $embedcode;
}
...
function makeseo2($text, $limit=150)
{
