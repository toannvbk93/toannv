...
verify_login_admin();
if (isset($_POST['submitform1']) && $_POST['submitform1'] == "1") {
	 $arr = array(
			 "title",
			 "value"
	 );
...
if (isset($_POST['submitform2']) &&  $_POST['submitform2'] == "1") {
	 $arr = array(
			 "title",
			 "value"
	 );
...
if (isset($_POST['submitform3']) && $_POST['submitform3'] == "1") {
	 $arr = array(
			 "title",
			 "value"
	 );
...
if (isset($_POST['submitform4']) && $_POST['submitform4'] == "1") {
	 $arr = array(
			 "title",
			 "value"
	 );
...
if (isset($_POST['submitform5']) && $_POST['submitform5'] == "1") {
	 $arr = array(
			 "title",
			 "value"
	 );
...
if (isset($_POST['submitform６']) && $_POST['submitform6'] == "1") {
	 $arr = array(
			 "title",
			 "value"
	 );
