...
if($_POST['submitform5'] == "1")
{
	...
	Stemplate::assign('message',$message);
}if($_POST['submitform6'] == "1"){	$arr = array("title", "value");	foreach ($arr as $value)	{		$sql = "update static set $value='".mysql_real_escape_string($_POST[$value])."' where ID='6'";		$conn->execute($sql);	}	$message = "FAQ Successfully Saved.";	Stemplate::assign('message',$message);}
...
Stemplate::assign('static5', $static[4]);Stemplate::assign('static6', $static[5]);
